    ...
    public function run(): void
    {
        DB::table('words')->insert([
            [
                'language_id' => 1,
                'word' => 'maternal',
                'meaning_en' => 'relating to a mother',
            ],
            [
                'language_id' => 1,
                'word' => 'vocational',
            ...
            [
                'language_id' => 1,
                'word' => 'testament',
                'meaning_en' => 'a persons will, especially the part relating to personal property.',
                'meaning' => 'وصیتنامه',
            ],
            [
                'language_id' => 1,
